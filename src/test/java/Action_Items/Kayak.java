...
//            2. click on search field
            Reusable_Library.click(driver,"//*[@aria-label='Pick-up location']","Airport Search Field");
//            3. enter an airport on input field  //your airPortName column value goes here
            Reusable_Library.userTypeAndHitEnter(driver,"//*[@name='pickup']",airport,"Airport Search Field");
//            4. click on enter date calendar **click on end date first because there is an issue when select start date before end i will show it in a video
            Reusable_Library.click(driver,"//*[contains(@id,'dateRangeInput-display-end')]","End Date Input");
            Thread.sleep(3000);
...
//            6. click somewhere outside to close the calendar screen
            Reusable_Library.click(driver,"//*[@class='title-section']","clicking outside");
            Thread.sleep(3000);
//            7. click on end time
            Reusable_Library.click(driver,"//*[contains(@id,'dateRangeInput-end-time-select-display')]","End Time Select");
            Thread.sleep(3000);
//            8. choose by clicking on an end time //your value from endTime column should be passed here as an xpath as text value
            Reusable_Library.mouseClick(driver,"//*[contains(@id,'dateRangeInput-end-time-select')and @data-title='"+endTime+"']","end time selection");
            Thread.sleep(3000);
//            9. click on start date calendar screen
            Reusable_Library.click(driver,"//*[contains(@id,'dateRangeInput-display-start')]","start Date Input");
            Thread.sleep(3000);
...
//            12. choose by clicking on a start time //your value from startTime column should be passed here as an xpath as text value
            Reusable_Library.click(driver,"//*[contains(@id,'dateRangeInput-start-time-select-display')]","Start Time Select");
            Thread.sleep(3000);
            Reusable_Library.mouseClick(driver,"//*[contains(@id,'dateRangeInput-start-time-select')and @data-title='"+startTime+"']","start time selection");
            Thread.sleep(3000);
//            13. click on search icon
            Reusable_Library.click(driver,"//*[contains(@id,'submit-wrapper')]","submit button");
            Thread.sleep(3000);
//            14. click on checkbox to select size //should be stored on xpath from column vehicleSize
            Reusable_Library.click(driver,"//*[@id='cars-topFilter-"+vehicleSize+"-checkbox_label']","Vehicle size checkbox");
            Thread.sleep(3000);
//            15. click on second index for 'View Deal' on first available car appears on the picture //use clickByindex method for this
            Reusable_Library.clickByIndex(driver,"//*[contains(text(),'View Deal')]",1,"Second Result");
            Thread.sleep(3000);
